...
const formatCardNumber = (number) => {
  // Divise la chaîne en groupes de 4 caractères et les rejoint avec des espaces
  ...
  >
    ...
    >
      <div>
        ...
        <!-- Afficher le numéro de carte ou valeur par défaut -->
        <div class="absolute h-[36px] w-[372px] text-white text-[28px] flex items-center font-space-grotesk top-[139px] left-[32px] tracking-[3px]">
           {{ formData.cardNumber ? formatCardNumber(formData.cardNumber) : defaultValues.cardNumber }}
        </div>
    ...
    <!-- Passe formData comme prop au composant Form -->
